...
| 来源 | 运行时地址 | 用途 |
|---|---|---|
| DSH Plugin Market | [仓库](https://github.com/dsh-market/dsh-market) / [machine snapshot](https://github.com/dsh-market/dsh-market/blob/main/data/registry-snapshot.json) | 优先使用它发布的机器可读清单，包含名称、分类、描述、GitHub/npm 安装 spec、来源页和热度 |
...
| SkillsMP | [市场](https://skillsmp.com) / [API 文档](https://skillsmp.com/docs/api) | 搜索 Skill 元数据；安装时回到条目的 GitHub source 下载完整 Skill 仓库 |
...
- 每张卡片显示来源、来源等级、原始来源链接、版本/快照信息和权限；部分上游不可用时会在市场栏提示。
